			...
			if(json.error){
				...
				for (var i = 0; i < json.data.items.length; i++) {
					...
					if(this.cfg.layout == 'thumbnails'){
						...
						//this.cfg.layout = full
						li.innerHTML = '<table cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" rowspan="2"></td><td valign="top"><b>'+entry.title+'</b><span>'+this.formatDescription(entry.description)+'</span></td></tr></table>';
